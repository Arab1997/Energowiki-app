    ...
    override fun bindViewHolder(holder: ViewHolder, data: Any) {
        when (type.type) {
            ...
            CalculatorMenus.ENGINE -> when (data) {
                ...
                7 -> holder.itemView.name.text = "Единичная компенсация мощноности трехнофазного электродвигателя"
                8 -> holder.itemView.name.text = "Мощность элекродвигателя для центробежного насоса"
                9 -> holder.itemView.name.text = "Мощность электродвигателя для поршневого компрессора"
                10 -> holder.itemView.name.text = "Мощность электродвигателя для вентилятро"
                11 -> holder.itemView.name.text = "Асимметрия напряжений трехфазного элеткродвигателя"
