...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sub_module_activity_main);
...
//apply the animation ( fade In ) to your LAyout
    ...
    public void addItemToDifficultySpinner() {
        difficulty = (Spinner) findViewById(R.id.difficulty1);
    ...
    View.OnClickListener checkboxClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (checked) {
                if (view.getId() == R.id.player1x) {
                    p1o.setChecked(false);
                    p2x.setChecked(false);
                    p2o.setChecked(true);
                    player1ax = true;
                } else if (view.getId() == R.id.player1o) {
                    p1x.setChecked(false);
                    p2o.setChecked(false);
                    p2x.setChecked(true);
                    player1ax = false;
                } else if (view.getId() == R.id.player2x) {
                    p2o.setChecked(false);
                    p1x.setChecked(false);
                    p1o.setChecked(true);
                    player1ax = false;
                } else if (view.getId() == R.id.player2o) {
                    p2x.setChecked(false);
                    p1o.setChecked(false);
                    p1x.setChecked(true);
                    player1ax = true;
                } else if (view.getId() == R.id.splayer) {
                ...
                } else if (view.getId() == R.id.tplayer) {
